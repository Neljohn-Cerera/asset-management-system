...
const ChartStockInComponent: React.FC = (): JSX.Element => {
  const { dashboardArrayStates } = useContext(DashboardContext);
  const chartDataSets = dashboardArrayStates.pieChartStockin.map(
    (val, index) => {
      return {
...
export default ChartStockInComponent;
